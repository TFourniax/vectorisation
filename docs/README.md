...
3. [`SEMANTIC_ABI.md`](SEMANTIC_ABI.md) — current Semantic ABI / conformity / adequacy / integrity model.
4. [`BENCHMARKS_V2.md`](BENCHMARKS_V2.md) — current evidence classes and falsification rules.
5. [`ROADMAP.md`](ROADMAP.md) — current evidence-gated next research gates.
6. [`PRIOR_ART.md`](PRIOR_ART.md) — living non-claim / prior-art map. It is not a patent opinion.
...
- [`SEMANTIC_COORDINATE_PROTOCOL.md`](SEMANTIC_COORDINATE_PROTOCOL.md) — coordinate-transition interchange draft; supporting SCF work, not the primary Semantic ABI thesis.
...
1. `CURRENT_STATUS.md`;
2. the relevant theory/protocol document (`SEMANTIC_ABI.md`, `BENCHMARKS_V2.md`, `ROADMAP.md`);
